...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selectuserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #A569BD;">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
         ...
         <footer class="text-center mt-5 py-2">
            <p>&copy 2023 <b>NIKHIL UPADHYAY</b> <br>BLUE Foundation</p>
        </footer>
